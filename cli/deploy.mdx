...
<Info>
**For parameter-only changes**, use [`codika redeploy`](/cli/redeploy) instead. It updates deployment parameters on an existing instance without creating a new template version — no version bump, no new deployment archive.
</Info>
