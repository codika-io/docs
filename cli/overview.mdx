---
title: "CLI Overview"
description: "Install and configure the codika CLI — the command-line tool for scaffolding, validating, and deploying Codika use cases"
---
...
The package name is `@codika-io/helper-sdk`. The binary is `codika`.
...
Configuration is stored at `~/.config/codika/config.json` (XDG-compliant) with permissions `0o600`.
