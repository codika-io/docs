...
const TRIGGER_URL = `https://api.codika.io/triggerwebhookpublic/${PROCESS_INSTANCE_ID}`;
...
CODIKA_TRIGGER_BASE_URL=https://api.codika.io/triggerwebhookpublic
CODIKA_STATUS_BASE_URL=https://api.codika.io/getexecutionstatuspublic
```
