---
title: "setup-codika"
description: "Skill for installing the codika CLI and managing authentication profiles"
---
...
```bash
codika login --api-key cko_your_key_here
```
...
```bash
codika config clear
codika config clear --profile <name>
```
