...
- `codika` CLI installed (no authentication needed)
...
codika verify use-case <path> --fix
...
# Strict mode
codika verify use-case ./my-use-case --strict

# Single workflow
codika verify workflow ./my-use-case/workflows/main.json

# JSON for CI
codika verify use-case ./my-use-case --json
```
