# Contributing to Codika Documentation
...
- **Use consistent terminology**: See AGENTS.md for the terminology guide
- **Include examples**: Show CLI commands with realistic flags and options
- **Use tables**: For reference data (options, fields, rules, exit codes)
