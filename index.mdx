...
| **codika CLI** | Command-line tool (`npm install -g @codika-io/helper-sdk`) for scaffolding, validating, and deploying use cases. |
...
<CardGroup cols={2}>
  ...
  <Card title="CLI reference" icon="terminal" href="/cli/overview">
    Full reference for all codika commands.
  </Card>
