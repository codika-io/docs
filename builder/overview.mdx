...
3. **Install both plugins** — follow the [Claude Code Plugin guide](/guides/claude-code-plugin) to add the marketplace and install the `codika` and `use-case-builder` plugins
