...
# Major version bump
codika deploy process-data-ingestion ./my-use-case --version-strategy major_bump

# Explicit version
codika deploy process-data-ingestion ./my-use-case --version-strategy explicit --explicit-version 3.0
