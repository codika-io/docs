...
description: "Promote a deployed use case from dev to production, set visibility and sharing, and manage dev/prod instance toggling"
---
...
<Info>
**Need to change parameters without a new version?** After publishing, use [`codika redeploy`](/operations/redeploy-use-case) to update deployment parameters on the prod instance without creating a new template version. Only the parameters you specify are changed — everything else stays the same.
</Info>
