---
title: "Initialize Use Case"
description: "Scaffold a new use case folder with config, template workflows, agent skills, version tracking, and optional platform project creation"
---
